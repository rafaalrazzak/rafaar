        ...
        <ThemeProvider attribute="class" storageKey="theme" enableSystem>
            <LazyMotion features={domAnimation}>
                <AnimatePresence initial={false} onExitComplete={onExitComplete} mode={"wait"}>
                    <m.div id="skip-content" key={router.route.concat(router.pathname)} variants={v} initial="hidden" animate="visible" exit="exit" className={(inter.className, "overflow-hidden")}>
                        <Provider>
                            <Component {...pageProps} />
                        </Provider>
                    </m.div>
