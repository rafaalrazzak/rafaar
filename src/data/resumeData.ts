...
export const RESUME_DATA = {
    ...
    about: "Front-end developer and designer from Indonesia. I love to create beautiful and functional web applications.",
    summary:
    ...
    avatarUrl: "https://www.rafaar.my.id/_next/image?url=%2Frafaar.jpg&w=256&q=100",
    ...
    work: [
        {
            ...
            description: "Your Hobby Makes Money! Come make money from your hobby and build a community like your favorite creator!",
        },
    ],
    skills: ["HTML", "CSS", "JavaScript", "TypeScript", "React/Next.js", "Tailwind CSS", "Node.js", "GraphQL", "PostgreSQL"],
    projects: [
        {
