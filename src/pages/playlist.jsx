...
export default function Playlist(){
  ...
  return (
      <DefaultLayout className="flex flex-col gap-4 min-h-screen">
        <SEO title="Playlist"/>
          ...
          <form>
            <div className="flex items-center gap-2">
              <input
                  ...
                  className="flex w-48 flex-1 rounded-full bg-transparent px-3 py-2 transition-colors duration-300 ease-linear focus:bg-green-500 hover:bg-green-500 hover:text-white ring-1 ring-green-500 focus:text-white focus:outline-none focus:placeholder:text-white md:w-auto"
              />
              <button
                  type={"submit"}
                  onClick={handleSearch}
                  className="flex rounded-full transition-colors  duration-300 ease-linear focus:bg-green-500 hover:bg-green-500 ring-1 ring-green-500 dark:ring-green-500 p-3"
              >
