...
export async function getServerSideProps(){
	const [{nowPlaying, topTracks}] = await Promise.all([fetch("https://api.rafaar.me/api/v1/personal/dynamic")
			.then((res) => res.json()),])
	...
	return {
		props: {
			nowPlaying, topTracks, gallery, projects,
		},
	}
}
	...
	return (
			<>
				<DefaultLayout>
					...
					{gallery && (
							<section
									className="flex flex-col items-center justify-center overflow-clip py-6 -mx-6 sm:-mx-14 md:-mx-12 ">
              ...
              Photo By Unsplash
					...
					<div className={twclsx("grid grid-cols-1 gap-2", {"lg:grid-cols-2": nowPlaying?.isPlaying})}>
						{nowPlaying?.isPlaying && (
								<section className="my-4 flex flex-col gap-4 shrink">
						...
						{topTracks && (
								<section className="my-4  flex flex-col gap-4 ">
									<h3>Top Tracks</h3>
									<div className="flex flex-wrap flex flex-1 lg:flex-nowrap gap-2 ">
