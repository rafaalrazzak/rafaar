...
const DropdownMenuSubContent = React.forwardRef(
  ({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent
      ref={ref}
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-100 bg-white/50 p-1 text-gray-700 shadow-md backdrop-blur-sm  backdrop-filter animate-in slide-in-from-left-1 dark:border-gray-800 dark:bg-black/50 dark:text-gray-400",
        className
      )}
      {...props}
    />
  ...
  ({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-100 bg-white/50 p-1 text-gray-700 shadow-md backdrop-blur-sm  backdrop-filter animate-in data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2 dark:border-gray-800 dark:bg-black/50 dark:text-gray-400",
          className
        )}
        {...props}
      />
...
const DropdownMenuSeparator = React.forwardRef(
  ({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.Separator
      ref={ref}
      className={cn(
        "-mx-1 my-1 h-px bg-gray-100 backdrop-blur-sm backdrop-filter dark:bg-black/50",
        className
      )}
      {...props}
    />
