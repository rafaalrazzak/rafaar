...
export const ThemeMenu = (props) => {
    ...
    const activeIndex = themesList.findIndex((theme) => theme.value === props.theme);
    ...
    return (
        ...
        >
            <ul
                ...
                tabIndex={-1}
                className={twclsx(mdscreen ? "flex flex-col gap-2 rounded-lg p-2.5" : "flex w-full items-center justify-between gap-2 p-2.5")}
            >
                {themesList.map((theme, index) => (
                    <li
                        ...
                        className={twclsx(
                            ...
                            props.theme === theme.value && "text-secondary-400 dark:text-secondary-500"
                        )}
                        key={theme.value}
