...
export default function PortfolioCard({
  ...
  return (
    <div className="sticky top-24">
      <div className=" relative  flex h-64 w-full flex-col justify-between overflow-clip rounded-xl bg-cover bg-center px-4  py-2 text-white ring-2 ring-white  transition-all duration-300 ease-in-out after:absolute  after:inset-0 after:bg-gradient-to-t after:from-black after:to-transparent dark:ring-primary-900">
        <Image
          src={cover}
          alt={title}
