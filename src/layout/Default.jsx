    ...
    <>
      <main>
        ...
        <Container className="group/bg relative  ">
          ...
          <div className="relative -mx-6 mx-auto rounded-t-xl border-x border-t border-secondary-700/80 bg-white px-6 py-4 dark:border-secondary-500/80 dark:bg-primary-900 sm:rounded-none sm:border-t-0">
            {children}
          </div>
        </Container>
      </main>
